...
export default function CTASection({ hasMounted }: CTASectionProps) {
  return (
    <motion.section
      ...
      className="relative overflow-hidden bg-linear-to-br from-red-600 via-red-500 to-red-700 text-white py-20"
    >
      {/* Decorative blur */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <button className="group cursor-pointer inline-flex items-center gap-2 bg-white text-red-600 font-bold px-10 py-4 rounded-xl shadow-lg hover:bg-red-50 hover:shadow-2xl transition-all duration-300">
          Get Started
